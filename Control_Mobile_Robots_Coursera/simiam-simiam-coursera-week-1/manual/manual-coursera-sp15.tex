...
Thanks to support from MathWorks, a license for MATLAB and all required toolboxes are available to all students for the duration of the course. Check the \emph{Preparing for Programming Assignments} page accessible from the \emph{Week 1} page for detailed instructions on how to download and install MATLAB on your computer.
...
\begin{enumerate}
\item Since the assignments in this course involve programming in MATLAB, you should familiarize yourself with MATLAB (both the environment and the language). Review the resources posted in the "Getting Started with MATLAB" section on the \textit{Preparing for Programming Assignments} page under \emph{Week 1}.
